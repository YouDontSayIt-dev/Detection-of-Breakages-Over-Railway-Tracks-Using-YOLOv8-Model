            ...
            {isModalOpen && (
              ...
              >
                ...
                <p className="w-full h-[80%] py-4 text-base text-left lg:text-2xl">
                  Inferencing refers to the process of using a trained model to make predictions or inferences on new, unseen data. Object detection involves identifying and locating objects within an image or a video frame. The trained model, often based on machine learning or deep learning techniques, has learned to recognize patterns and features that distinguish different
                  objects.
                </p>
