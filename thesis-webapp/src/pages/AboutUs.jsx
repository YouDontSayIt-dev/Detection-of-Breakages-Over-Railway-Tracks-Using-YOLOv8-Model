    ...
    <div className="bg-customBackground w-screen h-screen overflow-hidden">
      ...
      <div className="grid grid-flow-col scroll-auto gap-[5rem] overscroll-x-contain snap-mandatory snap-x overflow-y-hidden">
        ...
        <div className="w-[280px] md:w-[320px] h-[502px] flex flex-col bg-[#071017] rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
          ...
          <div className="flex justify-center mt-[78px]">
            <div className=" relative w-[202px] h-[32px]">
              <img className="w-[32px] left-0 absolute h-[32px] top-0" alt="Vector" src={facebook} />
              <img className="w-[32px] left-[58px] absolute h-[32px] top-0" alt="Vector" src={instagram} />
              <img className="w-[32px] left-[115px] absolute h-[32px] top-0" alt="Vector" src={github} />
              <img className="w-[29px] left-[173px] absolute h-[32px] top-0" alt="Vector" src={linkin} />
            </div>
          </div>
        </div>
        ...
        <div className="w-[280px] md:w-[305px] h-[502px] flex flex-col bg-[#071017] rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
          {/* CONTAINER FOR IMAGE  */}
          <div className="mt-[50px] flex justify-center">
              <img className="w-[200px] h-[200px] object-cover block" alt="" src={finn_img} />
          </div>
        ...
        <div className="w-[280px] md:w-[305px] h-[502px] flex flex-col bg-[#071017] rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
          {/* CONTAINER FOR IMAGE  */}
          <div className="mt-[50px] flex justify-center">
              <img className="w-[200px] h-[200px] object-cover block" alt="" src={james_img} />
          </div>
        ...
        <div className="w-[280px] md:w-[305px] h-[502px] flex flex-col bg-[#071017] rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
          {/* CONTAINER FOR IMAGE  */}
          <div className="mt-[50px] flex justify-center">
              <img className="w-[200px] h-[200px] object-cover block" alt="" src={mark_img} />
          </div>
        ...
        <div className="w-[280px] md:w-[305px] h-[502px] flex flex-col bg-[#071017] rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
          {/* CONTAINER FOR IMAGE  */}
          <div className="mt-[50px] flex justify-center">
              <img className="w-[200px] h-[200px] object-cover block" alt="" src={seph_img} />
          </div>
