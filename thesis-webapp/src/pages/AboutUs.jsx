...
const AboutUs = () => {
  ...
  return (
    <div className="bg-customBackground dark:bg-customLightBackground w-full h-full overflow-hidden">
      {/* SIDEBAR COMPONENT  */}
      ...
      <div className="w-full flex justify-center items-center mt-[50px] lg:mt-[100px] px-4">
        ...
        <div className="grid grid-flow-col scroll-auto gap-[5rem] overscroll-x-contain snap-mandatory snap-x overflow-y-hidden px-40">
          ...
          <div className="w-[280px] md:w-[305px] h-[502px] flex flex-col bg-[#071017] dark:bg-[#23605F] dark:border-customLightBorder dark:shadow-customLightShadow rounded-[24px] border-4 border-solid border-[#228a88] shadow-[-10px_10px_50.4px_#228a88]">
            {/* CONTAINER FOR IMAGE  */}
