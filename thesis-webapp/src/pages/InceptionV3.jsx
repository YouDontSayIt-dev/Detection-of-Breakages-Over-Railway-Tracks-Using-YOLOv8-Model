  ...
  return (
    <div className="flex flex-col w-full h-full bg-customBackground overflow-x-hidden">
      ...
      <div className="flex h-[10%] lg:h-[30%] ml-[80px] lg:ml-[125px] items-center md:justify-between pt-[56px] md:p-[56px]">
          ...
          <div className="flex">
            <h1 className="text-lg md:text-4xl font-bold text-justify text-ebony items-center justify-center">InceptionV3 Model</h1>
            <svg
              width="9"
              height="9"
              viewBox="0 0 36 32"
          ...
          <div className="flex">
            ...
            {isModalOpen && (
              <div
              className="absolute top-[84px] right-5 lg:right-20 z-50 w-[280px] lg:w-[531px] h-[600px] lg:h-[515px] bg-customSidebarColor rounded-customPopUp p-8 text-ebony"
              >
                ...
                <p className="w-full h-[80%] py-4 text-base text-left lg:text-2xl">
                  ...
                  consisting of 16 layers, including 13 convolutional layers and
                  3 fully connected layers. The convolutional layers use small
                  3x3 filters with a stride of 1 and are followed by max-pooling
                  layers with 2x2 filters and a stride of 2. The use of small
                  filters and deep layers helps the network learn hierarchical
