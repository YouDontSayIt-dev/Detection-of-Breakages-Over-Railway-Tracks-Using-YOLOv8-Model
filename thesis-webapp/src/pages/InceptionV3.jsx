    ...
    <div className="flex flex-col w-full h-full bg-customBackground overflow-x-hidden">
      ...
      <div className="w-full h-[320px] overflow-x-hidden">
        <div className="flex h-[30%] ml-[125px] items-center justify-between p-[56px]">
          ...
          {/* LEFT ITEMS */}
          <div className="flex">
            <h1 className="text-4xl font-bold text-ebony">InceptioV3 Model</h1>
            <svg
              width="36"
              height="32"
              viewBox="0 0 36 32"
            ...
            {isModalOpen && (
              ...
              >
                ...
                <p className="w-full h-[80%] py-4 text-2xl">
                  The Inception architecture is characterized by the use of
                  "Inception modules," which are blocks containing multiple
                  parallel convolutional layers with different filter sizes.
                  These modules allow the network to capture features at various
                  spatial scales and learn hierarchical representations.
                </p>
