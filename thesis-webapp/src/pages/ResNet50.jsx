    ...
    <div className="flex flex-col w-full h-full bg-customBackground overflow-x-hidden">
      ...
      <div className="w-full h-[320px] overflow-x-hidden">
        <div className="flex h-[30%] ml-[125px] items-center justify-between p-[56px]">
          ...
          {/* LEFT ITEMS */}
          <div className="flex">
            <h1 className="text-4xl font-bold text-ebony">ResNet50 Model</h1>
            <svg
              width="36"
              height="32"
              viewBox="0 0 36 32"
            ...
            {isModalOpen && (
              ...
              >
                ...
                <p className="w-full h-[80%] py-4 text-2xl">
                  ResNet-50 is a deep convolutional neural network architecture
                  that belongs to the ResNet (Residual Network) family. The key
                  innovation in the ResNet architecture is the use of residual
                  blocks, which contain shortcut connections (skip connections)
                  that skip one or more layers. These skip connections enable
                  the network to learn residual mappings, making it easier to
