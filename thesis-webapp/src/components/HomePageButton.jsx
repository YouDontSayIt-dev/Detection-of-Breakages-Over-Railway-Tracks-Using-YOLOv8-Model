...
export default function HomePageButton(props){
    return(
      <button className="text-[12px] md:text-2xl text-[#EBEBEB] font-bold bg-[#071017] rounded-customBtn border-4 border-[#228A88] px-2 py-1 shadow-[0_0_69px_3px_rgba(0,255,255,0.25)]">
