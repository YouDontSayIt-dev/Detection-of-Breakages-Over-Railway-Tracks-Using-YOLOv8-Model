...
const ImageDisplay = ({ selectedImage, drawLine, bboxData, radioBtnValue }) => {
  ...
  if (radioBtnValue === "image") {
    return (
      <div className="w-[280px] h-[300px] md:w-[602px] lg:w-[1152px] lg:h-[550px] mx-auto border-8 border-customImageDisplay shadow-customImageDisplay rounded-customImageDisplay">
    ...
    return (
      <div className="flex flex-col w-[280px] h-[300px] md:w-[602px] lg:w-[1152px] lg:h-[550px] mx-auto border-8 border-customImageDisplay shadow-customImageDisplay rounded-customImageDisplay">
